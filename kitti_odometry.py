...
class KittiEvalOdom():
    ...
    """
    def __init__(self):
        #self.lengths = [5, 10, 25, 50, 75, 100, 150, 200]
        self.lengths = [0.25, 0.5, 1, 2, 4, 8, 16, 20]
        self.num_lengths = len(self.lengths)

    def load_poses(self, list_of_poses):
        ...
        poses = {}
        for cnt, pose in enumerate(list_of_poses):
            poses[cnt] = pose
        return poses
    ...
    def eval(self, gt_poses, result_poses, 
                alignment=None,
                seqs=None):
        ...
        poses_result = self.load_poses(result_poses)
        poses_gt = self.load_poses(gt_poses)
        ...
        return 100*ave_t_err, ave_r_err/np.pi*180, ate
